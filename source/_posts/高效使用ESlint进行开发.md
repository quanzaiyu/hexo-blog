...
- [ESLint 验证规则](http://eslint.cn/docs/rules/)
- [ESLint 配置文件](http://eslint.cn/docs/user-guide/configuring)
...
```
2. 在VSCode中安装[eslint插件](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint)

![](http://oss.xiaoyulive.top/imgs/0001.png)
...
![](http://oss.xiaoyulive.top/imgs/0003.png)
...
完整的规则可访问[ESLint配置规则列表](http://eslint.cn/docs/rules/)

其中带 ` √ ` 标记的表示该规则为推荐规则，带`修复图标`的表示可以使用 `--fix` 进行修复。
...
```json
"eslint.options": {
    "configFile": "C:/eslint/.eslintrc.js"
}
```

![](http://oss.xiaoyulive.top/imgs/0004.png)
...
此时，可以在问题栏中看到`eslint`代码检测抱怨的问题

![](http://oss.xiaoyulive.top/imgs/0005.png)
...
> - Deprecated：`.eslintrc`，此文件可以是JSON或者YAML
> - package.json：在`package.json`文件中创建eslintConfig属性，所有的配置包含在此属性中。
...
具体的规则可以在[官网](http://eslint.org/docs/rules/)上找到，或者使用别人写好的配置，例如[eslint-config-airbnb](https://www.npmjs.com/package/eslint-config-airbnb)。
...
- [vscode的eslint支持html插件，检查html/vue文件不再是梦](https://zhuanlan.zhihu.com/p/24401049) 
- [详解 ESLint 规则，规范你的代码](https://segmentfault.com/a/1190000006194584) 
- [三省吾身 - 详解 ESLint 规则，规范你的代码](http://guowenfh.github.io/2016/08/07/ESLint-Rules/) 
- 简书 : [ESLint简介](http://www.jianshu.com/p/2bcdce1dc8d4) 
